...
class XenForo_Route_PrefixAdmin_Attachments implements XenForo_Route_Interface
{
	/**
	...
	public function match($routePath, Zend_Controller_Request_Http $request, XenForo_Router $router)
	{
		...
		return $router->getRouteMatch('XenForo_ControllerAdmin_Attachment', $action, 'attachments');
	}
