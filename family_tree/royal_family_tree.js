...
(FamilyTree._defaultConfig = function (e) {
                        ...
                        if (!a.notifierUI.show(e.notif)) {
                            ...
                            if ((FamilyTree.events.publish("render", [a, n]), (o = n.content), (e = n.res), (o += a.ui.lonely(a.config)), t !== FamilyTree.action.exporting)) {
                                ...
                                if (a._initialized) {
                                    ...
                                    (a.element.innerHTML = a.ui.css() + b + a.ui.menuButton(a.config)),
    ...
    (FamilyTree.prototype._replaceIds = function (e) {
        ...
        if (Array.isArray(this.config.roots)) for (i = 0; i < this.config.roots.length; i++) this.config.roots[i] == a && (this.config.roots[i] = n);
        if (this.nodes)
        ...
        if (-1 != m.indexOf("multiline")) {
            ...
            for (var F = 1, x = 1; x < g.length; x++) {
                ...
                if (((T.firstChild.data += " " + g[x]), T.getComputedTextLength() > c)) {
                    ...
                    (T = document.createElementNS(p, "tspan")).setAttributeNS(null, "x", l),
    ...
    (FamilyTree.accentFold = function (e) {
        return (e = e.toString().toLowerCase()).replace(/([Ă Ă¡Ă¢Ă£Ă¤Ă¥])|([Ă§])|([Ă¨Ă©ĂªĂ«])|([Ă¬Ă­Ă®Ă¯])|([Ă±])|([Ă²Ă³Ă´ĂµĂ¶Ă¸])|([ĂŸ])|([Ă¹ĂºĂ»Ă¼])|([Ă¿])|([Ă¦])/g, function (e, t, i, r, a, n, o, l, s, d, c) {
            ...
            var T = function (e, t) {
                ...
                b = function (t) {
                    if (h) {
                        ...
                        if (s.left || s.right || s.up || s.down) {
                            ...
                            var E = (i.x - h.x) / d,
                                M = (i.y - h.y) / d;
                            if (((u[4] = y + E), (u[5] = g + M), !e._dragEventFired && (Math.abs(i.x - h.x) > FamilyTree.FIRE_DRAG_NOT_CLICK_IF_MOVE || Math.abs(i.y - h.y) > FamilyTree.FIRE_DRAG_NOT_CLICK_IF_MOVE)))
                ...
                F = function (t) {
                    if (
                        ...
                        return p.removeChild(f), (o._gragStartedId = null), void (e._dragEventFired && FamilyTree.events.publish("drop", [o.nodeCircleMenuUI, { from: s.id, menuItemName: a, menuItem: n, event: t }]));
                    var r = o.getNode(c);
                    FamilyTree.events.publish("drop", [o.nodeCircleMenuUI, { from: s.id, to: r.id, menuItem: n, menuItemName: a, event: t }]), T(c, m), p.removeChild(f), (o._gragStartedId = null);
                };
    ...
    (FamilyTree.prototype._draggableHandler = function (e, t, i) {
        ...
        var S = { x: d.x, y: d.y },
            ...
            N = function (t) {
                if (S) {
                    ...
                    var l = FamilyTree._getOffsetXY(r.element, t),
                        d = { left: r.width() - (l.x + r.config.padding) < 0, right: l.x - r.config.padding < 0, up: r.height() - (l.y + r.config.padding) < 0, down: l.y - r.config.padding < 0 };
                    if (d.left || d.right || d.up || d.down) {
                        ...
                        if (
                            (r.moveEnd(),
                            s.classList && (s.classList.add("bft-cursor-grab"), s.classList.remove("bft-cursor-move"), s.classList.remove("bft-cursor-nodrop"), s.classList.remove("bft-cursor-copy")),
                            I(w, k),
                            (w = null),
                            (k = null),
                        ...
                        if (null != w) {
                            ...
                            !r.canUpdateLink(c[0].id, w) && s.classList
                                ? (s.classList.remove("bft-cursor-grab"), s.classList.remove("bft-cursor-move"), s.classList.remove("bft-cursor-copy"), s.classList.add("bft-cursor-nodrop"))
                                : s.classList && (s.classList.remove("bft-cursor-grab"), s.classList.remove("bft-cursor-move"), s.classList.add("bft-cursor-copy"), s.classList.remove("bft-cursor-nodrop"));
                        }
                        var P = (i.x - S.x) / C,
                            D = (i.y - S.y) / C;
            ...
            A = function (t) {
                ...
                if (
                    (r.moveEnd(),
                    s.classList && (s.classList.remove("bft-cursor-grab"), s.classList.remove("bft-cursor-move"), s.classList.remove("bft-cursor-nodrop"), s.classList.remove("bft-cursor-copy")),
            ...
            g = function (t) {
                if (c) {
                    ...
                    if (g.left || g.right || g.up || g.down) {
                        ...
                        var A = (i.x - c.x) / f,
                            L = (i.y - c.y) / f;
                        if (((m[4] = p + A), (m[5] = h + L), !e._dragEventFired && (Math.abs(i.x - c.x) > FamilyTree.FIRE_DRAG_NOT_CLICK_IF_MOVE || Math.abs(i.y - c.y) > FamilyTree.FIRE_DRAG_NOT_CLICK_IF_MOVE)))
    ...
    (FamilyTree.manager._iterate = function (e, t, i, r, a, n, o, l, s, d, c, m) {
        ...
        if (
            ...
            ((FamilyTree.MIXED_LAYOUT_ALL_NODES && h.length > FamilyTree.MIXED_LAYOUT_IF_NUMBER_OF_CHILDREN_IS_MORE_THEN && h.length == t.parent.childrenIds.length - f - u) ||
                (!FamilyTree.MIXED_LAYOUT_ALL_NODES && h.length > FamilyTree.MIXED_LAYOUT_IF_NUMBER_OF_CHILDREN_IS_MORE_THEN)) &&
                (l[t.pid] = h);
        }
    ...
    (FamilyTree.manager._createNodes = function (e) {
        ...
        for (c = 0; c < w.length; c++) {
            ...
            for (b = 0; b < g.subLevels; b++) {
                ...
                if ((FamilyTree.manager._initDinamicNode(H, g.lcn), (v = g.parent)))
                    (ue = v.children.indexOf(g)) > -1 && (v.children.splice(ue, 1), v.children.splice(ue, 0, H)), H.children.push(g), (H.parent = v), (g.parent = H), (l[H.id] = H);
            }
        }
        for (var $ in _) {
            (v = l[$]).hasAssistants = !0;
            ...
            for (b = v.children.length - 1; b >= 0; b--) {
                (D = v.children[b]).isAssistant
                    ...
                    : D.isPartner ||
                      (D.parent && k[D.parent.id] && H && D.parent.id != H.id && (Object.defineProperty(k, H.id, Object.getOwnPropertyDescriptor(k, D.parent.id)), delete k[D.parent.id]),
                      (D.parent = H),
            ...
            for (var $ in k) {
                ...
                if ((z = i[v.lcn ? v.lcn : "base"]).layout > 0 || ee) {
                    (te.pnode = v),
                        ...
                        te.layouts.length || te.layouts.push({ layout: te.layout, childrenIds: te.childrenIds, subLevels: te.subLevels });
                        ...
                        if (he.layout == FamilyTree.layout.mixed) {
                            ...
                            for (b = 0; b < ve.length; b += 3) {
                                ...
                                0 != b && (W = l[ve[b - 3]]),
                                    ...
                                    (G.parent = W),
                                    W.children.push(G),
                                    J && (0 != b && (W = l[ve[b - 2]]), (J.parent = W), W.children.push(J)),
                                    K && (0 != b && (W = l[ve[b - 1]]), (K.parent = W), W.children.push(K));
                            }
                        }
                    }
                }
    ...
    (FamilyTree.manager._getResponse = function (e, t, i, r, a, n, o, l, s, d, c, m, p, h, f) {
        ...
        return { animations: v, boundary: g, viewBox: s, visibleNodeIds: y, nodes: p, allFields: FamilyTree.manager.getAllFields(r) };
    }),
    (FamilyTree.manager._iterate2 = function (e, t, i, r, a, n, o, l, s, d) {
        if (FamilyTree.manager._isVisible(e, i, r, a)) {
            ...
            if ((a == FamilyTree.action.expand || a == FamilyTree.action.collapse || a == FamilyTree.action.maximize) && l && l[e.id] && "expandCollapseToLevel" == n.method) {
                ...
                if ((null != (f = l[e.id]).x && null != f.y && (c = { x: f.x, y: f.y }), (h = t[n.id]) && h == e)) (m = e.parent) && m.id == n.id && (c = { x: h.x + h.w / 2 - e.w / 2, y: h.y + h.h / 2 - e.h / 2 });
    ...
    (FamilyTree.ui = {
        ...
        node: function (e, t, i, r, a, n, o, l, s, d) {
            ...
            for (var h in o) {
                ...
                if (
                    ((p.value = f), (p.element = c[h]), (p.name = u), (p.field = h), !1 !== FamilyTree.events.publish("field", [d, p]) && null != p.value && null != p.value && null != p.element && (!y || (y && !FamilyTree.isNEU(p.value))))
                ) {
        ...
        link: function (e, t, i, r, a, n, o) {
            ...
            if (e.hasPartners) {
                    ...
                    (T = e.children[g]).parentPartner
                        ? ((y.ppnodes[T.id] = T.parentPartner),
                          ...
                          1 == T.parentPartner.isPartner
                              ? (-1 == y.rightIds.indexOf(T.parentPartner.id) && y.rightIds.push(T.parentPartner.id), (y.indexes[T.id] = y.rightIds.indexOf(T.parentPartner.id)), y.firstRight || (y.firstRight = T))
                              : 2 == T.parentPartner.isPartner && (-1 == y.leftIds.indexOf(T.parentPartner.id) && y.leftIds.push(T.parentPartner.id), (y.indexes[T.id] = y.leftIds.indexOf(T.parentPartner.id)), (y.lastLeft = T)))
                ...
                (y.maxSidePartnersWithChildren = Math.max(y.leftIds.length, y.rightIds.length)),
                    (h = 0 == y.maxSidePartnersWithChildren ? t.config.minPartnerSeparation / 2 : t.config.minPartnerSeparation / 2 + y.partnerChildrenSplitSeparation * y.maxSidePartnersWithChildren + y.partnerChildrenSplitSeparation / 2);
            }
            for (g = 0; g < e.children.length; g++) {
                ...
                if (S) (v = S), (x = x.replace("{rounded}", S).replace("{edge}", S).replace("{curve}", v));
                    ...
                    if ((F.xa == F.xb && F.xa == F.xc && F.xa == F.xd) || (F.ya == F.yb && F.ya == F.yc && F.ya == F.yd)) (v = "M" + F.xa + "," + F.ya + " L" + F.xd + "," + F.yd), (x = x.replace("{rounded}", v));
                        ...
                        (v = "M" + F.xa + "," + F.ya + " L" + F.xa + "," + F.yd), (x = x.replace("{rounded}", v));
                        ...
                        (v = "M" + F.xa + "," + F.ya + " L" + F.xd + "," + F.ya), (x = x.replace("{rounded}", v));
                    else {
                    ...
                    -1 != x.indexOf("{edge}")
                        ? ((v = "M" + F.xa + "," + F.ya + " " + F.xb + "," + F.yb + " " + F.xc + "," + F.yc + " L" + F.xd + "," + F.yd), (x = x.replace("{edge}", v)))
                        : -1 != x.indexOf("{curve}")
                        ? ((v = "M" + F.xa + "," + F.ya + " C" + F.xb + "," + F.yb + " " + F.xc + "," + F.yc + " " + F.xd + "," + F.yd), (x = x.replace("{curve}", v)))
                        : ((v = x.replaceAll("{xa}", F.xa).replaceAll("{ya}", F.ya).replaceAll("{xb}", F.xb).replaceAll("{yb}", F.yb).replaceAll("{xc}", F.xc).replaceAll("{yc}", F.yc).replaceAll("{xd}", F.xd).replaceAll("{yd}", F.yd)),
                          (x = v));
                c.push(
                ...
                FamilyTree.events.publish("render-link", [t, N]), c.push(N.html), o && m.push({ id: e.id, childId: T.id, html: N.html });
                var A = "";
        ...
        for (var s = l.querySelector("svg"), d = e.element.querySelector("#bft-ppdf-content"), c = 0; c < a.length; c++) {
            ...
            a[c].footer && (f = a[c].footer),
                ...
                a[c].html
                    ...
                    : (s.setAttribute("viewBox", a[c].vb), p.write(FamilyTree._exportHtml(l.innerHTML, t.styles, r, a[c].innerSize.w, a[c].innerSize.h, h, f, e.config.mode)));
        ...
        for (var i = "", r = 0; r < this.config.clinks.length; r++) {
            ...
            if (n && -1 != t.res.visibleNodeIds.indexOf(n.id) && o && -1 != t.res.visibleNodeIds.indexOf(o.id)) {
                ...
                switch (this.config.orientation) {
                    case FamilyTree.orientation.top:
                    case FamilyTree.orientation.top_left:
                        h <= f ? ((g = 1), (m.x = h + n.w / 10), (p.x = f - o.w / 10)) : ((g = -1), (m.x = h - n.w / 10), (p.x = f + o.w / 10)),
                            s == c ? ((g = 1), (m.y = s), (p.y = c)) : s > c ? ((m.y = s), (p.y = c + o.h)) : ((m.y = s + n.h), (p.y = c));
                        break;
                    case FamilyTree.orientation.bottom:
                    case FamilyTree.orientation.bottom_left:
                        h <= f ? ((g = -1), (m.x = h + n.w / 10), (p.x = f + o.w / 10)) : ((g = 1), (m.x = h - n.w / 10), (p.x = f + o.w / 10)),
                            s == c ? ((g = -1), (m.y = s + n.h), (p.y = c + o.h)) : s > c ? ((m.y = s), (p.y = c + o.h)) : ((m.y = s + n.h), (p.y = c));
                        break;
                    case FamilyTree.orientation.left:
                    case FamilyTree.orientation.left_top:
                        u <= y ? ((g = -1), (m.y = u + n.h / 5), (p.y = y + o.h / 5)) : ((g = 1), (m.y = u - n.h / 5), (p.y = y + o.h / 5)),
                            l == d ? ((g = -1), (m.x = l), (p.x = d)) : l > d ? ((m.x = l), (p.x = d + o.w)) : ((m.x = l + n.w), (p.x = d));
                        break;
                    case FamilyTree.orientation.right:
                    case FamilyTree.orientation.right_top:
                        u <= y ? ((g = 1), (m.y = u + n.h / 5), (p.y = y + o.h / 5)) : ((g = -1), (m.y = u - n.h / 5), (p.y = y + o.h / 5)),
                            l == d ? ((g = 1), (m.x = l + n.w), (p.x = d + o.w)) : l > d ? ((m.x = l), (p.x = d + o.w)) : ((m.x = l + n.w), (p.x = d));
                }
                var v = _(m, p, g),
                    T = a.template;
                T || (T = "orange");
    ...
    (FamilyTree.prototype._slinks = function (e, t) {
        ...
        function n(t, n, o) {
            ...
            o && ((U = n.id), (O = t.id)),
                (i +=
                    ("<g " + FamilyTree.attr.s_link_from + '="{from}" ' + FamilyTree.attr.s_link_to + '="{to}">').replace("{from}", U).replace("{to}", O) +
    ...
    (FamilyTree.prototype.showTreeMenu = function (e) {
        ...
        for (g = 0; g < l.length; g++)
            ((l[g].fid == c.id && FamilyTree.isNEU(l[g].mid)) || (l[g].mid == c.id && FamilyTree.isNEU(l[g].fid))) &&
                (l[g].fid == c.id ? (l[g].mid = "_ft_partner_for_single_child") : l[g].mid == c.id && (l[g].fid = "_ft_partner_for_single_child"), m.push(l[g]), v.push(l[g].id));
        if (v.length) {
            var T = { id: "_ft_partner_for_single_child", pids: [e], templateName: "partner", _ft_method: "addPartnerAndParentNodes", _ft_childIds: v, _ft_partnerData: { pids: [e] }, _ft_id: e };
